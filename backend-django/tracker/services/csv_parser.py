"""
CSV parsing with smart column auto-detection.

Carried over from FastAPI backend. Only change: imports PropertyCreate
from tracker.schemas instead of app.models.property.
"""
import csv
import io
import re
...
from tracker.schemas import PropertyCreate
...
def detect_columns(headers: list[str]) -> dict[str, Optional[int]]:
    ...
    Two-pass matching: exact match first, then substring fallback.
    """
    mapping = {}
