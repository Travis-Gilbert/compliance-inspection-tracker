...
export default function Import() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Results */}
      {result && (
        <div className="bg-civic-green-pale border border-civic-green/20 rounded-lg p-4">
          <div className="font-medium text-civic-green text-sm">
            Import complete: {result.imported} properties imported
          </div>
          {result.skipped > 0 && (
            <div className="text-xs text-gray-600 mt-1">{result.skipped} rows skipped</div>
          )}
          ...
          <button
            onClick={() => navigate("/")}
            className="mt-3 text-xs font-medium text-civic-green underline hover:no-underline"
          >
